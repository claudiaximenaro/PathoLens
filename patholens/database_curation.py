...
def build_curated_database(species_to_exclude_file, group, save_intermediate=False):
    ...
    filter_fasta_only_retained_taxonomy(species_to_exclude_file, fasta_file, group, group_output_dir,save_intermediate)
